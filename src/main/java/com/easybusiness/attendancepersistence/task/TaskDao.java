...
import com.easybusiness.attendancepersistence.activity.ActivityRepository;
...
public class TaskDao {
	...
	return taskRepository.findByActivity(activityRepository.findById(activityId).get(0));
    }
